...
class UserController {
   ...
   * @Method POST
   * @Access Public
   * @Description Creates the account to asociate the user, then and assig admin rights by default and sends verification email;
   */
  register = () => async (req, res) => {
    try {
      ...
      //TODO MODIFY USER MODEL TO INCLUDE VERIFICATION TOKEN AND EXPIRATION
